...
public class ParaphraseDerivation {
  ...
  public final FeatureSimilarity embSimilarity;
  ...
  public ParaphraseDerivation(LanguageInfo lInfo,
                              ParaphraseExample paraEx,FeatureSimilarity embSimilarity, FormulaGenerationInfo fgInfo,
      ParaphraseFeatureExtractor fExtractor, Params params) {
    this.langInfo = lInfo;
    this.vsSimilarity=paraEx.featureSimilarity;
    this.embSimilarity=embSimilarity;
  ...
  private LispTree toLispTree() {
    ...
    if(embSimilarity!=null)
      tree.addChild(embSimilarity.toLispTree());
    if(alignment!=null)
  ...
  public void incrementAllFeatureVector(double incr, Map<String, Double> counts) {
    ...
    if(embSimilarity!=null)
      embSimilarity.featureVector.increment(incr, counts);
    if(alignment!=null)
  ...
  private void scoreProofDeriv(Params params) {
    ...
    double embScore = embSimilarity!=null ? embSimilarity.featureVector.dotProduct(params) : 0.0;
    ...
    score =
            vsmScore+embScore+alignmentScore+derivationScore;
  }
